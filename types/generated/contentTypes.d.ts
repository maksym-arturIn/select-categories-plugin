...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    categories: Schema.Attribute.JSON & Schema.Attribute.CustomField<"plugin::select-categories.select-categories">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginSelectCategoriesCategoryTree extends Struct.CollectionTypeSchema {
  collectionName: "category-tree";
  info: {
    description: "";
    displayName: "Category Tree";
    pluralName: "category-trees";
    singularName: "category-tree";
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    data: Schema.Attribute.JSON & Schema.Attribute.Required & Schema.Attribute.DefaultTo<[]>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::select-categories.category-tree"> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "plugin::select-categories.category-tree": PluginSelectCategoriesCategoryTree;
