...
//   return <div className="sss">{formatMessage(intlLabel)}</div>;
// };
...
const SelectCategoriesSettings = ({ attribute, onChange, ...props }: any) => {
  const { formatMessage } = useIntl();
...
export default SelectCategoriesSettings;
